...
public class BloodBankService implements Serializable {
    ...
    public void buildUserForNewPerson(Person newPerson) {
        ...
        SecurityRole userRole = (SecurityRole) /* TODO - use NamedQuery on SecurityRole to find USER_ROLE */ em.createNamedQuery(USER_ROLE);
        ...
        if (person != null) {
            ...
            TypedQuery<SecurityUser> findUser = 
                /* TODO - use NamedQuery on SecurityRole to find this related Person
                   ...
                   is not dangling
                */ em.createNamedQuery(USER_ROLE, SecurityUser.class);
